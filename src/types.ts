 ...
 */
 export type GenerationMethod = (typeof generationMethods)[number];
 ...
 */
export type Base62GenerationOptions = __BaseGenerationOptions;
 ...
 */
export type ApiKeyResults = string | string[];
